<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="班组长用户ID" prop="teamLeader">
        <el-input
    ...
    <el-table v-loading="loading" :data="teamList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="班组长用户ID" align="center" prop="teamLeader" />
      <el-table-column label="班组描述" align="center" prop="description" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="班组长用户ID" prop="teamLeader">
          <el-input v-model="form.teamLeader" placeholder="请输入班组长用户ID" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除班组信息编号为"' + teamIds + '"的数据项？').then(function() {
